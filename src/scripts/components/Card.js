...
export class Card {
    ...
    constructor({id, title, description, user, time},background,[btn],column){
    ...
    createCard(){
        return `<div class="card" draggable="true" id="${this.id}" style="background-color:${this.background};" >
